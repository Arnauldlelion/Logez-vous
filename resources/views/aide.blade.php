...
<section class="container-horizontal01">
    <div class="horizontal-section01">
            ...
            <h6 style="color: #ff040c">Où trouver les informations pour remplir ma déclaration d'impôts / revenus fonciers ?</h6><hr>
       
       
          
            <h6 style="color: #ff040c">Puis-je me rétracter suite à la signature d'un mandat de gestion locative ?</h6><hr>
        </div>
    </div>
</section>
	<section id="main">
		<div class="nav justify-content-center">
            <a href="locataire-link" class="nav-link active">Je suis locataire</a><br>
            <a href="proprietaire-link" class="nav-link active">Je suis propriétaire</a>
        </div>
		<hr>
		<div id="locataire-questions" class="question-section">
