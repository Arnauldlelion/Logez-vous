                ...
                <div class="container col-lg-10">
                    <div class="card-body">
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="form-group row mb-5 d-block d-lg-flex align-items-center ">
                                <label for="number_of_pieces" class="col-sm-2 col-form-label-sm">Nombre de Pièces</label>
                                <div class="col-12 col-lg-7">
                                    <input
                            ...
                            <div class="form-group row mb-5 d-block d-lg-flex ">
                                <label for="description" class="col-sm-2 col-form-label-sm">Dèscription <em>*</em></label>
                                <div class="col-12 col-lg-7">
