    ...
    <div class=" auth-fluid-form-box" >
        <div class="align-items-center d-flex h-100" >
            ...
            <div class="card-body">
                 ...
                 <!-- form -->
                 <form action="{{route('admin.pieces.update', $piece->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row mb-5 d-block d-lg-flex align-items-center gap-5">
                          ...
                          {{-- <input class="form-control rounded-pill form-control-sm @error('pieces_types_id') is-invalid @enderror" type="text"
                            ...
                            @foreach(\App\Models\PieceType::all() as $piece_type)
                               <div class="d-flex gap-3">
                                <input type="radio" name="piece_types_id" {{ $piece_type->id == $piece->piece_types_id ? 'checked' : '' }} value={{$piece_type->id}} id="">
                      ...
                      <div class="form-group row mb-5 d-block d-lg-flex align-items-center gap-5">
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            id="nombre_of_pieces"
                            value="{{ old('nombre_of_pieces', $piece->nombre_of_pieces) }}"
