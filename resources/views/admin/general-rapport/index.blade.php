            ...
            <div class="col-md-12">
                <div class="card card-body">
                    <div class="text-end p-2">
                        <a href="{{ route('admin.rapport-general.create') }}" class="btn btn-secondary float-right">Ajouter un Rapport De Gestion</a>
                    </div>
                            ...
                            <tbody>
                                @forelse($apartment->AnnualRapportDeGestions as $rapport)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>
                                            <a href="#" onclick="openPdfModal('{{ asset('storage/Rapport/' . $rapport->rapport) }}')">
                                                <i class="mdi mdi-file-pdf" style="color: red; font-size: 24px;" aria-hidden="true"></i> View PDF
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <x-delete-modal :id="$rapport->id"
                                                    :url="route('admin.rapport-general.destroy', $rapport->id)"
                                                    :content="'Voulez-vous vraiment supprimer ce Rapport <strong>' .
                                                    $rapport->id .
