        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-body">
                    <div class="p-4">
                        <h4 class="text-capitalize">{{ $apartment->property->name }} > Appartement {{ $apartment->id }} >
                            Paiements - {{ $apartment->property->location }}</h4>
                    </div>
                    <div class="text-end p-2">
                        <a href="{{ route('landlord.payments.create') }}" class="btn btn-secondary">Ajouter un nouveau paiement</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm text-white">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="100%">Aucun paiement trouvé</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
