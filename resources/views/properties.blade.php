...
@section('content')
    <section class="" style="padding-top: 8rem; padding-bottom: .5rem;">
        <div class="ms-2">
            <div class="search-block">
                <form action="YOUR_FORM_ACTION_URL" method="GET">
                    <input type="text" name="search" placeholder="Search">
                    <button type="submit">Search</button>
                </form>
            </div>
            <div class="button-container">
                <button name="loyer"><i class="fa-solid fa-euro-sign"></i> Loyer</button>
                <button name="surface"><i class="fa-regular fa-square"></i>Surface</button>
                <button name="meuble"><i class="fa-solid fa-couch"></i>Meubles?</button>
            </div>
            <div class="button2-container">
                <button name="nomres-de-pieces"><i class="fa-brands fa-windows"></i>Nombre de pièces</button>
                <button name="plus-de-filtres">Plus de filtres</button>
            </div>
            <div class="button3-container">
                <button name="creer-une-alerte" style="color: #ff040c">Créer une alerte</button>
            </div>
            <div class="checkbox-container">
                <input type="checkbox" id="logements-louer" name="logements-louer" value="true" checked>
    ...
    <section class="container2">
        <div class="block-left">
            <h2>95 logements disponibles</h2>
            <div class="ms-2">
