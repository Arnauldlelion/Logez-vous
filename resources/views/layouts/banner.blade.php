            ...
            <div class="col-12 col-md-7 mx-auto">
                ...
                <div class="" style="background: white; border-radius:10px;">
                    <ul class="nav nav-tabs d-flex justify-content-center align-items-end mb-4 gap-md-5" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active py-3 fs-6" id="tab1-tab" data-bs-toggle="tab" href="#tab1"
                                role="tab" aria-controls="tab1" aria-selected="true">LOCATAIRE</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-3 fs-6" id="tab2-tab" data-bs-toggle="tab" href="#tab2" role="tab"
