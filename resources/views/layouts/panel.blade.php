                    ...
                    <nav class="sidebar sidebar-offcanvas" id="sidebar">
                        <div
                            ...
                            <a class="sidebar-brand brand-logo" href="/"><img
                                    src="/storage/images/logos/logez-vous.png" alt="logo"
                                    style="height: 9rem; padding-top: 3rem; " /></a>
                                ...
                                <div class="collapse" id="ui-basic">
                                    <ul class="nav flex-column sub-menu">
                                        <li class="nav-item"> <a class="nav-link"
                                                href="pages/ui-features/buttons.html">Rapport de gestion</a></li>

                                        <li class="nav-item"> <a class="nav-link"
                                                href="pages/ui-features/typography.html">Mes outils</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item menu-items">
