            ...
            <div class="wrapper">
                ...
                <form action="{{ route('apartments.filter') }}" method="POST" id="filterForm">
                    ...
                    <div class="d-flex justify-content-between price-input mb-1">
                        ...
                        <div class="field col-5 input-group-sm d-flex mb-3">
                            <input type="number" class="form-control rounded-start-pill input-max" name="max_price"
                                id="maxPriceInput" value="10000">
                    ...
                    <div class="range-input mb-4">
                        <input type="range" class="range-min" name="range_min" id="rangeMinInput" min="0"
                            max="10000" value="0">
                        <input type="range" class="range-max" name="range_max" id="rangeMaxInput" min="0"
        ...
        <div class="popup" id="popup2">
            ...
            <div class="wrapper">
                ...
                <form method="POST" action="{{ route('apartments.filter') }}">
                    ...
                    <div class="range-input mb-4">
                        <input type="range" class="size-range-min" name="size-range_min" min="0"
                            max="100" value="0">
                        <input type="range" class="size-range-max" name="size-range_max" min="0"
                            max="100" value="100">
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between align-items-center">
