...
!(function (t, n) {
    ...
    Pn.prototype = zn.prototype = {
        ...
        property: function (t, n) {
            return arguments.length > 1
                ? this.each(
                      (null == n ? tn : "function" == typeof n ? en : nn)(t, n)
                  )
                : this.node()[t];
        },
        ...
        text: function (t) {
            return arguments.length
                ? this.each(
                      null == t ? hn : ("function" == typeof t ? pn : dn)(t)
                  )
        ...
        html: function (t) {
            return arguments.length
                ? this.each(
                      null == t ? gn : ("function" == typeof t ? vn : yn)(t)
                  )
                : this.node().innerHTML;
        },
        raise: function () {
    ...
    function qe(t) {
        ...
        return (
            r === i && i === o
                ? (n = e = a)
                : ((n = Oe(
                      (0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Ne
                  )),
                  (e = Oe(
                      (0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Ce
                  ))),
    ...
    ca.prototype = fa.prototype = {
        ...
        arc: function (t, n, e, r, i, o) {
            ...
            null === this._x1
                ? (this._ += "M" + c + "," + f)
                : (Math.abs(this._x1 - c) > aa ||
                      Math.abs(this._y1 - f) > aa) &&
                  (this._ += "L" + c + "," + f),
                e &&
                    (l < 0 && (l = (l % oa) + oa),
                    l > ua
            ...
            if (
                ...
                if (t) {
                    ...
                    c.quadraticCurveTo(0, 0, v * $o(_), v * Wo(_)),
                        c.arc(0, 0, v, _, b);
            if (
                (c.quadraticCurveTo(0, 0, p * $o(g), p * Wo(g)),
                c.closePath(),
                f)
            )
    ...
    class Va {
        ...
        arc(t, n, e) {
            ...
            null === this._x1
                ? (this._ += `M${r},${i}`)
                : (Math.abs(this._x1 - r) > Ga ||
                      Math.abs(this._y1 - i) > Ga) &&
                  (this._ += "L" + r + "," + i),
                e &&
                    (this._ += `A${e},${e},0,1,1,${
                        t - e
    ...
    (Xu.copy = function () {
        ...
        (Xu.visitAfter = function (t) {
            ...
            for (
                this._root &&
                e.push(
                    new Uu(this._root, this._x0, this._y0, this._x1, this._y1)
                );
                (n = e.pop());
    ...
    var fc = {
        ...
        s: function (t, n) {
            ...
            var r = e[0],
                ...
                o =
                    i -
                    (ic = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                    1,
                a = r.length;
            return o === a
                ? r
    ...
    function vc(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(rc(n) / 3))) -
                rc(Math.abs(t))
        );
    }
    function _c(t, n) {
    ...
    var Zp = Bp(
        ...
        eg = Bp(
            ...
            (t, n) =>
                (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Hp) /
                Gp,
            (t) => t.getDate() - 1
        ),
        rg = eg.range;
        ...
        return Bp(
            ...
            function (t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * Hp) /
                    Vp
                );
            }
        );
    ...
    function Hy(t, n) {
        return (
            (t = jy(t)), cy(fg.count(xg(t), t) + (4 === xg(t).getDay()), n, 2)
        );
    }
    function Xy(t) {
        return t.getDay();
    ...
    (ex.prototype = tx.prototype),
                    ...
                    for (a = 0, i = new Array(f); a < s; ++a)
                        ((c = t[a]).index = a),
                            "object" != typeof c.source &&
                                (c.source = Ku(l, c.source)),
                            "object" != typeof c.target &&
                                (c.target = Ku(l, c.target)),
        ...
        (t.geoCircle = function () {
            ...
            return (
                (a.center = function (t) {
                    return arguments.length
                        ? ((e =
                              "function" == typeof t ? t : ls([+t[0], +t[1]])),
                          a)
                        : e;
                }),
                (a.radius = function (t) {
        ...
        (t.pie = function () {
            ...
            function a(a) {
                var u,
                    ...
                    v = Math.min(
                        pb,
                        Math.max(-pb, i.apply(this, arguments) - y)
                    ),
        ...
        (t.stack = function () {
            ...
            return (
                (i.keys = function (n) {
                    return arguments.length
                        ? ((t = "function" == typeof n ? n : rb(Array.from(n))),
                          i)
                        : t;
                }),
                (i.value = function (t) {
        ...
        (t.thresholdFreedmanDiaconis = function (t, n, e) {
            return Math.ceil(
                (e - n) /
                    (2 * (H(t, 0.75) - H(t, 0.25)) * Math.pow(c(t), -1 / 3))
            );
        }),
        ...
        (t.tree = function () {
            ...
            function i(i) {
                var c = (function (t) {
                    for (
                        var n, e, r, i, o, a = new Nd(t, 0), u = [a];
                        (n = u.pop());
